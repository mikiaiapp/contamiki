...
const App: React.FC = () => {
  ...
  const handleRefreshData = async () => {
      ...
      try {
          ...
          console.error("App: Refresh Error caught", err);
          if (err.message.includes('401') || err.message.includes('403')) {
              logout();
          }
      }
