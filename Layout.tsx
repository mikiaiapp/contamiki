    ...
    <div className="flex h-screen bg-slate-50 text-slate-900 flex-col lg:flex-row overflow-hidden font-sans">
      ...
      >
        ...
        <div className="px-6 pb-8 space-y-2">
          ...
          {/* Logo Branding - OPTIMIZADO PARA VISIBILIDAD */}
          <div className="flex justify-center py-2 px-2 group cursor-default">
            <div className="bg-white py-6 px-4 rounded-[1.5rem] shadow-2xl w-full flex items-center justify-center transform group-hover:scale-105 transition-transform duration-500 border border-slate-100/10">
                <img 
                    src="/logo.png" 
